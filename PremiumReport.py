...
prioritypp=['priority++','priority++1']
...
username.extend(get_members(prioritypp))
...
for user in username:
    ...
    account_prioritypp[user]=get_premium(user,prioritypp)
...
account_prioritypp_df=pd.DataFrame.from_dict(account_prioritypp,orient='index',columns=['priority++'])
